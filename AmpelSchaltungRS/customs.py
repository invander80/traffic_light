...
class CodeEditor(QPlainTextEdit):
	def __init__(self, parent=None):
		...
		self.setStyleSheet("""background-color: #1a161f;
		color: #c6d4e1;
		font: 11pt "Consolas";
		border:0px;
		border-bottom:0px;		
	...
	def keyPressEvent(self, event):
		...
		if event.key() == Qt.Key_8 and event.modifiers() == Qt.ControlModifier:
			self.insertPlainText("[]")
		if event.modifiers() == Qt.ShiftModifier and event.key() == Qt.Key_9:
			self.insertPlainText("()")
